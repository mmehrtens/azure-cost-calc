...
>All cost parameters need to be multiplied by $\big(1-D_{azure}\big)$ to get the discounted value, given that the provided discount applies to all Azure services.
